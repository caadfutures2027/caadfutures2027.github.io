document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Phase system ──
  const PHASES = {
    A: { label: 'Now', title: 'Full Paper Call Open', desc: 'Full paper submission deadline: <s class="deadline-old">September 15, 2026 (AoE)</s> <strong class="deadline-new">September 30, 2026 (AoE)</strong> <span class="deadline-badge">Extended</span>', btn: 'Submit Paper', link: 'papers.html' },
